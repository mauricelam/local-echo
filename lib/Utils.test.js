...
test('getSharedFragement', () => {
  expect(getSharedFragment([ 'foo-1', 'foo-2' ])).toEqual('foo-');
  expect(getSharedFragment([ 'foo-1', 'foo-2', 'a' ])).toEqual('');

  expect(getSharedFragment([ 'foo-1', 'foo-2', 'f' ])).toEqual('f');

  expect(getSharedFragment([ 'foo-1', 'foo-2', 'fuu' ])).toEqual('f');

  expect(getSharedFragment([ 'foo', 'foo', 'foo' ])).toEqual('foo');
});
